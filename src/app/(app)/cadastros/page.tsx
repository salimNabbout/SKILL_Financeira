...
export default async function CadastrosPage() {
  ...
  const cards: Array<{ href: string; title: string; description: string; count: number }> = [
    ...
    { href: "/cadastros/recorrencias", title: "Recorrências", description: "Despesas mensais que geram títulos a pagar automaticamente (ex.: aluguel, salários).", count: recurringTemplates.length },
