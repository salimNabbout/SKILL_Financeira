...
export default async function CadastrosPage() {
  ...
  const cards: Array<{ href: string; title: string; description: string; count: number }> = [
    ...
    { href: "/cadastros/subcategorias-pagar", title: "Subcategoria a PAGAR", description: "Lista de subcategorias que alimenta a caixa SUBCATEGORIA do novo título em Contas a pagar.", count: payableSubcategories.length },
    { href: "/cadastros/categorias-receber", title: "Categoria a RECEBER", description: "Lista de categorias que alimenta o campo CATEGORIA (opcional) em Contas a receber.", count: categories.filter((c) => c.kind === "income").length },
